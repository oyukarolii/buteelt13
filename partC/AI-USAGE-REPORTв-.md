...
Ойролцоогоор 350 мөр код бөгөөд гараар бичвэл 2-3 цаг зарцуулах байсан.
...
**Архитектурын шийдвэр**  ийг өөрөө хийх гэж хичээсэн. "3 давхар бүтэц
(Routes → Services → DB) ашиглах уу, эсвэл Repository pattern нэмэх үү?" гэсэн
асуултад AI-аас санал авж загварчилсан. Academic scope-д
...
уялдуулах нь миний шийдвэр байсан. AI нэрийн санал өгсөн ч mapping-ийг өөрөө
тогтоосон.
...
хувилбараас хамаарсан асуудал гэдгийг npm docs-оос оллоо.
...
байсан ч `helmet` нэмэгдээгүй. `helmet` нь Express-д автоматаар
...
## 5. Юу AI-аар удаан хийсэн? (Бэрхшээл, антипаттерн)
...
**Дүгнэлт**: AI нь productivity хэрэгсэл — нь хурдан хийдэгч дотор код болон бүтцэд дутагдал их үлдээсэн санагдлаа. Эхэндээ promt оо сайн ойлгомжтой детайл тай өгөхгүй бол хүсээгүй үр дүн гаргасан тул 2-3 хоног үнэгүй эрхээ байхгүй болгосон учираас promt өгөхдөө ойлгомжтой байх ёстой юм байна
AI -аар хийлгэсний дараа заавал дараа нь сайн нягталж өөрөө засах ёстойг ойлголлоо
